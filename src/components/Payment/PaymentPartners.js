...
function PaymentPartners() {
  return (
    <div className="d-md-flex color-primary p-4  " style={{backgroundColor:"#f3f4f5", borderRadius:"20px"}}>
      <div className="col-md-6 mb-5 ">
        <div className="d-flex flex-column align-items-center ">
        <img width={250} src={"https://images.pexels.com/photos/210742/pexels-photo-210742.jpeg?auto=compress&cs=tinysrgb&dpr=1&w=500"} alt="mpesa" className=" mb-5" />
